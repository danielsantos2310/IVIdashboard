const STORAGE_KEY = "ivi_current_match_v3";
    ...
    const SFX_TRACKS = {
      ...
      climaTerrivel: "vai se criando um clima terrível.mp3",
    ...
    const SFX_LABELS = {
      ...
      climaTerrivel: "Clima Terrivel 🌪️",
